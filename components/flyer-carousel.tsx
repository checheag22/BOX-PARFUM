            ...
            <>
              ...
              <div className="absolute left-[30%] top-[62%] -translate-x-1/2 -translate-y-1/2">
                <a
                  ...
                  className="inline-flex w-[120px] items-center justify-center rounded-full bg-red-600 px-3 py-1 text-[8px] font-semibold uppercase tracking-[0.18em] text-white shadow-lg transition hover:-translate-y-0.5 hover:bg-red-500 md:w-[220px] md:px-4 md:py-2 md:text-[10px] md:tracking-[0.3em]"
                >
                  Ver ofertas
                </a>
              </div>
